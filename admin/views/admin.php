...
<div class="wrap">
   ...
   <div id="tabs-6">
	   <textarea rows="15" cols="100" id="wpaioab_custom_css" name="wpaioab_settings[wpaioab_custom_css]" style="resize: none;" >
	   <?php if ( isset( $wpaioab_options['wpaioab_custom_css'] ) ) echo $wpaioab_options['wpaioab_custom_css']; ?>
	   </textarea>
   </div>
